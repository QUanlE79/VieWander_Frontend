                                ...
                                <div className='md:p-6 bg-white max-sm:max-w-[300px] md:min-w-[811px] '>
                                    <div>
                                        ...
                                        <Link to={`/detail/${dataProvince && dataProvince[0]?._id}`} className='relative w-full'>
                                            <img className='w-full h-[102px] object-cover rounded-lg' src={`https://vie-wander-backend.onrender.com/public/images/provinces/${dataProvince && dataProvince[0]?.images[0]}`} />
