            ...
            <div className="grid grid-cols-3 gap-1 relative">
                {
                    imagesData.map((n, i) => i < 6 ? <div key={i} onClick={onZoom}>
                        <img src={`https://vie-wander-backend.onrender.com/public/images/landmarks/${n}`} className={`w-full h-full object-cover rounded-md cursor-pointer ${i == 5 ? `opacity-40` : ""}`}></img>
                    </div> : "")
                }
